...
- [ ] **1.2. Error Handling Foundation**
  ...
  - [ ] 1.2.2. Implement `SyntaxError` variant with line/column info
  - [ ] 1.2.3. Implement `RuntimeError` variant with stack trace support
  - [ ] 1.2.4. Implement `TypeError` variant for type mismatches
  - [ ] 1.2.5. Add `Display` and `Error` trait implementations
  - [ ] 1.2.6. Create error reporting utilities with source code snippets
  - [ ] 1.2.7. Write unit tests for error formatting
  - [ ] 1.2.8. Create example file: `examples/errors/basic_error.mtx`

- [ ] **1.3. Testing Infrastructure**
  - [ ] 1.3.1. Set up `tests/` directory structure
  - [ ] 1.3.2. Create test harness for running `.mtx` files
...
- [ ] **2.3. Literal Tokenization**
  ...
  - [ ] 2.3.8. Create example file: `examples/lexer/literals.mtx`
...
- [ ] **2.4. Identifier and Keyword Tokenization**
  ...
  - [ ] 2.4.7. Create example file: `examples/lexer/identifiers.mtx`
...
- [ ] **2.5. Operator and Delimiter Tokenization**
  ...
  - [ ] 2.5.6. Create example file: `examples/lexer/operators.mtx`
...
- [ ] **3.2. Expression AST Nodes**
  ...
  - [ ] 3.2.10. Create example file: `examples/parser/expressions.mtx`
...
- [ ] **3.3. Method Call and Access Expressions**
  ...
  - [ ] 3.3.7. Create example file: `examples/parser/method_calls.mtx`
...
- [ ] **3.4. Statement AST Nodes**
  ...
  - [ ] 3.4.6. Create example file: `examples/parser/statements.mtx`
...
- [ ] **3.5. Block Statement (Core Meta-Object)**
  ...
  - [ ] 3.5.8. Create example file: `examples/parser/blocks.mtx`
...
- [ ] **3.6. Control Flow AST Nodes**
  ...
  - [ ] 3.6.7. Create example file: `examples/parser/control_flow.mtx`
...
- [ ] **3.7. Exception Handling AST Nodes**
  ...
  - [ ] 3.7.8. Create example file: `examples/parser/exceptions.mtx`
...
- [ ] **3.8. Pattern Matching AST Nodes**
  ...
  - [ ] 3.8.10. Create example file: `examples/parser/pattern_matching.mtx`
...
- [ ] **3.9. Function and Method Definition Nodes**
  ...
  - [ ] 3.9.8. Create example file: `examples/parser/functions.mtx`
...
- [ ] **3.10. Class Definition Nodes**
  ...
  - [ ] 3.10.7. Create example file: `examples/parser/classes.mtx`
...
- [ ] **3.12. Parser Testing and Examples**
  ...
  - [ ] 3.12.4. Create example: `examples/parser/complete_program.mtx`
...
- [ ] **4.2. Object Type System**
  ...
  - [ ] 4.2.7. Create example file: `examples/runtime/types.mtx`
...
- [ ] **4.4. Instance Structure**
  ...
  - [ ] 4.4.7. Create example file: `examples/runtime/instances.mtx`
...
- [ ] **4.5. Method Structure**
  ...
  - [ ] 4.5.8. Create example file: `examples/runtime/methods.mtx`
...
- [ ] **4.6. Exception Structure**
  ...
  - [ ] 4.6.9. Create example file: `examples/runtime/exceptions.mtx`
...
- [ ] **4.7. Built-in Base Classes**
  ...
  - [ ] 4.7.16. Create example file: `examples/runtime/builtin_classes.mtx`
...
- [ ] **5.3. Variable Resolution**
  ...
  - [ ] 5.3.6. Create example file: `examples/runtime/variable_scope.mtx`
...
- [ ] **6.4. Method Call Implementation**
  ...
  - [ ] 6.4.10. Create example file: `examples/runtime/method_dispatch.mtx`
...
- [ ] **6.5. Block Execution (Critical Meta-Programming Feature)**
  ...
  - [ ] 6.5.9. Create example file: `examples/metaprogramming/block_call.mtx`
...
- [ ] **6.6. Control Flow Execution**
  ...
  - [ ] 6.6.7. Create example file: `examples/runtime/loops.mtx`
...
- [ ] **6.7. Class and Instance Creation**
  ...
  - [ ] 6.7.7. Create example file: `examples/runtime/class_instantiation.mtx`
...
- [ ] **6.8. Inheritance Implementation**
  ...
  - [ ] 6.8.6. Create example file: `examples/runtime/inheritance.mtx`
...
- [ ] **6.9. Exception Handling Execution**
  ...
  - [ ] 6.9.11. Create example file: `examples/runtime/exception_handling.mtx`
...
- [ ] **6.10. Pattern Matching Execution**
  ...
  - [ ] 6.10.10. Create example file: `examples/runtime/pattern_matching.mtx`
...
- [ ] **6.11. Error Reporting and Stack Traces**
  ...
  - [ ] 6.11.7. Create example file: `examples/runtime/error_reporting.mtx`
...
- [ ] **7.1. Block as First-Class Object**
  ...
  - [ ] 7.1.6. Create example file: `examples/metaprogramming/blocks_as_objects.mtx`
...
- [ ] **7.2. Implicit Block Capture**
  ...
  - [ ] 7.2.6. Create example file: `examples/metaprogramming/implicit_blocks.mtx`
...
- [ ] **7.3. `define_method` Implementation**
  ...
  - [ ] 7.3.7. Create example file: `examples/metaprogramming/define_method.mtx`
...
- [ ] **7.4. `get_source` Implementation**
  ...
  - [ ] 7.4.6. Create example file: `examples/metaprogramming/get_source.mtx`
...
- [ ] **7.5. AST Inspection API**
  ...
  - [ ] 7.5.7. Create example file: `examples/metaprogramming/ast_inspection.mtx`
...
- [ ] **7.6. DSL Examples and Tests**
  ...
  - [ ] 7.6.7. Create example file: `examples/dsl/test_framework.mtx`
  - [ ] 7.6.8. Create example file: `examples/dsl/html_builder.mtx`
...
- [ ] **8.1. String Methods**
  ...
  - [ ] 8.1.10. Create example file: `examples/stdlib/strings.mtx`
...
- [ ] **8.2. Array Methods**
  ...
  - [ ] 8.2.12. Create example file: `examples/stdlib/arrays.mtx`
...
- [ ] **8.3. Hash/Dict Methods**
  ...
  - [ ] 8.3.8. Create example file: `examples/stdlib/hashes.mtx`
...
- [ ] **8.4. Numeric Methods**
  ...
  - [ ] 8.4.8. Create example file: `examples/stdlib/numbers.mtx`
...
- [ ] **8.5. IO and Print Functions**
  ...
  - [ ] 8.5.7. Create example file: `examples/stdlib/io.mtx`
...
- [ ] **8.6. Set Methods**
  ...
  - [ ] 8.6.8. Create example file: `examples/stdlib/sets.mtx`
...
- [ ] **8.7. Built-in Testing Framework**
  ...
  - [ ] 8.7.11. Create example file: `examples/stdlib/testing_framework.mtx`
...
- [ ] **9.1. Command Line Interface**
  ...
  - [ ] 9.1.3. Add `metorex <file.mtx>` command
...
- [ ] **12.7. Closure and Upvalue Compilation**
  ...
  - [ ] 12.7.7. Create example file: `examples/compiler/closures.mtx`
...
- [ ] **13.8. Closure and Upvalue Execution**
  ...
  - [ ] 13.8.8. Create example file: `examples/vm/closures.mtx`
...
- [ ] **14.1. Runtime Method Definition**
  ...
  - [ ] 14.1.7. Create example file: `examples/metaprogramming/bytecode_define_method.mtx`
...
- [ ] **14.2. Method Missing Hook**
  ...
  - [ ] 14.2.5. Create example file: `examples/metaprogramming/method_missing.mtx`
...
- [ ] **14.3. Runtime Class Modification**
  ...
  - [ ] 14.3.6. Create example file: `examples/metaprogramming/class_modification.mtx`
...
- [ ] **14.4. Reflection and Introspection**
  ...
  - [ ] 14.4.8. Create example file: `examples/metaprogramming/reflection.mtx`
...
- [ ] **14.5. AST Manipulation**
  ...
  - [ ] 14.5.6. Create example file: `examples/metaprogramming/ast_manipulation.mtx`
...
- [ ] **14.6. Trait/Interface System**
  ...
  - [ ] 14.6.18. Create example file: `examples/traits/basic_traits.mtx`
  - [ ] 14.6.19. Create example file: `examples/traits/trait_bounds.mtx`
...
- [ ] **16.2. Import Syntax and Parsing**
  ...
  - [ ] 16.2.7. Create example file: `examples/modules/import_syntax.mtx`
  - [ ] 16.2.8. Create test file: `tests/import_parsing_tests.rs`

- [ ] **16.3. File Loading System**
  - [ ] 16.3.1. Implement file system layer to locate `.mtx` files from disk
...
- [ ] **16.7. Namespace Binding**
  ...
  - [ ] 16.7.7. Create example file: `examples/modules/namespace_binding.mtx`
...
- [ ] **16.9. Circular Import Detection**
  ...
  - [ ] 16.9.6. Create example file: `examples/modules/circular_imports.mtx`
...
- [ ] **16.10. Relative Imports (Optional)**
  ...
  - [ ] 16.10.6. Create example file: `examples/modules/relative_imports.mtx`
  - [ ] 16.10.7. Create test file: `tests/relative_import_tests.rs`

- [ ] **16.11. Package Support (Optional)**
  - [ ] 16.11.1. Implement package semantics with `__init__.mtx` files
...
- [ ] **16.13. Networking Library**
  ...
  - [ ] 16.13.16. Create example file: `examples/networking/http_client.mtx`
  - [ ] 16.13.17. Create example file: `examples/networking/http_server.mtx`
  - [ ] 16.13.18. Create example file: `examples/networking/websocket.mtx`
...
- [ ] **16.14. Serialization Library**
  ...
  - [ ] 16.14.13. Create example file: `examples/serialization/json_advanced.mtx`
  - [ ] 16.14.14. Create example file: `examples/serialization/xml.mtx`
  - [ ] 16.14.15. Create example file: `examples/serialization/yaml.mtx`
...
- [ ] **16.15. Cryptography Library**
  ...
  - [ ] 16.15.14. Create example file: `examples/crypto/hashing.mtx`
  - [ ] 16.15.15. Create example file: `examples/crypto/encryption.mtx`
  - [ ] 16.15.16. Create example file: `examples/crypto/secure_random.mtx`
...
- [ ] **16.16. Advanced Collections**
  ...
  - [ ] 16.16.13. Create example file: `examples/collections/advanced.mtx`
...
- [ ] **17.3. C FFI (Optional)**
  ...
  - [ ] 17.3.5. Create example: `examples/ffi/c_interop.mtx`
...
- [ ] **18.1. Fiber/Green Thread Implementation**
  ...
  - [ ] 18.1.7. Create example file: `examples/concurrency/fibers.mtx`
...
- [ ] **18.2. Async/Await Support**
  ...
  - [ ] 18.2.6. Create example file: `examples/concurrency/async_await.mtx`
...
- [ ] **18.4. OS-Level Threading**
  ...
  - [ ] 18.4.14. Create example file: `examples/concurrency/threads.mtx`
...
- [ ] **18.5. Synchronization Primitives**
  ...
  - [ ] 18.5.13. Create example file: `examples/concurrency/synchronization.mtx`
...
- [ ] **18.6. Atomic Operations and Lock-Free Structures**
  ...
  - [ ] 18.6.10. Create example file: `examples/concurrency/atomics.mtx`
...
- [ ] **18.7. Channels and Message Passing**
  ...
  - [ ] 18.7.11. Create example file: `examples/concurrency/channels.mtx`
...
- [ ] **19.5. JIT Compilation with LLVM**
  ...
  - [ ] 19.5.7. Create example file: `examples/optimization/jit_compilation.mtx`
...
- [ ] **19.6. Optional Type System**
  ...
  - [ ] 19.6.17. Create example file: `examples/types/type_annotations.mtx`
  - [ ] 19.6.18. Create example file: `examples/types/generics.mtx`
...
- [ ] **20.1. Debugger**
  ...
  - [ ] 20.1.9. Create example: `examples/tools/debugging.mtx`
...
- [ ] **20.6. Documentation System**
  ...
  - [ ] 20.6.8. Implement documentation generator (`mtxdoc` tool)
  ...
  - [ ] 20.6.16. Create example file: `examples/docs/documented_module.mtx`
  - [ ] 20.6.17. Create test file: `tests/documentation_tests.rs`

- [ ] **20.7. Build System Features**
  - [ ] 20.7.1. Implement build configuration file (`build.mtx` or `Metorex.toml`)
  ...
  - [ ] 20.7.15. Create example file: `examples/build/build_config.mtx`
...
- [ ] **23.1. Hygienic Macro System**
  ...
  - [ ] 23.1.9. Create example file: `examples/macros/basic_macros.mtx`
...
- [ ] **23.2. Procedural Macros**
  ...
  - [ ] 23.2.7. Create example file: `examples/macros/procedural.mtx`
...
- [ ] **23.3. Compile-Time Evaluation**
  ...
  - [ ] 23.3.7. Create example file: `examples/comptime/const_eval.mtx`
...
- [ ] **24.1. Advanced Function Features**
  ...
  - [ ] 24.1.7. Create example file: `examples/functional/function_composition.mtx`
...
- [ ] **24.2. Algebraic Data Types**
  ...
  - [ ] 24.2.9. Create example file: `examples/functional/adt.mtx`
...
- [ ] **24.3. Immutable Data Structures**
  ...
  - [ ] 24.3.7. Create example file: `examples/functional/immutable.mtx`
...
- [ ] **24.4. Lenses and Optics**
  ...
  - [ ] 24.4.6. Create example file: `examples/functional/lenses.mtx`
...
- [ ] **25.1. WebAssembly Compilation**
  ...
  - [ ] 25.1.7. Create example file: `examples/wasm/basic.mtx`
...
- [ ] **25.2. WASI Support**
  ...
  - [ ] 25.2.6. Create example file: `examples/wasm/wasi.mtx`
...
- [ ] **25.3. Browser Integration**
  ...
  - [ ] 25.3.6. Create example file: `examples/wasm/browser_app.mtx`
...
- [ ] **26.1. Sandboxing and Isolation**
  ...
  - [ ] 26.1.7. Create example file: `examples/security/sandbox.mtx`
...
- [ ] **26.2. Taint Checking**
  ...
  - [ ] 26.2.6. Create example file: `examples/security/taint_checking.mtx`
...
- [ ] **26.3. Security Policies**
  ...
  - [ ] 26.3.6. Create example file: `examples/security/policies.mtx`
...
- [ ] **27.1. CPU Profiler**
  ...
  - [ ] 27.1.7. Create example file: `examples/profiling/cpu_profile.mtx`
...
- [ ] **27.2. Memory Profiler**
  ...
  - [ ] 27.2.7. Create example file: `examples/profiling/memory_profile.mtx`
...
- [ ] **28.1. C ABI Compatibility**
  ...
  - [ ] 28.1.5. Create example file: `examples/interop/c_abi.mtx`
...
- [ ] **28.2. Language Bridges**
  ...
  - [ ] 28.2.6. Create example file: `examples/interop/python_bridge.mtx`
...
- [ ] **28.3. Protocol Support**
  ...
  - [ ] 28.3.5. Create example file: `examples/interop/grpc.mtx`
