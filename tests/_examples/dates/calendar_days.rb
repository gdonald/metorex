...
p (reform + 1).to_s
p reform.julian?
p (reform + 1).gregorian?
p Date.civil(1582, 10, 4, Date::ENGLAND).julian?

walked = []
Date.civil(2008, 1, 16).upto(Date.civil(2008, 1, 19)) { |day| walked.push(day.day) }
p walked
p Date.civil(2008, 1, 16).step(Date.civil(2008, 1, 22), 2).map { |day| day.day }
