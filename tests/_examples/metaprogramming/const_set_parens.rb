# Module#const_set — written with parentheses. Covers return value,
# anonymous-module naming (including the cascade into nested anonymous
# modules), name validation, and the frozen check.
mod = Module.new
