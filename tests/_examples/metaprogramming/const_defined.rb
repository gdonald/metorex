# Module#const_defined? — written without parentheses where possible.
# Covers own constants, ancestor lookup, the inherit flag (with boolean
# coercion), scoped and toplevel-anchored names, unicode constant names,
# and NameError on invalid names.
module Outer
  CS_CONSTλ = :unicode
