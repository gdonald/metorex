# Module#constants — written without parentheses where possible. Covers
# own constants, mixin constants (transitively), the inherit flag,
# private_constant filtering, Symbol indexing, and Array difference.
module Deep
  DEEP_CONST = 1
end
