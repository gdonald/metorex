# Module#const_get — written with parentheses. Covers ancestor lookup,
# the inherit flag, scoped and toplevel-anchored names, const_missing
# dispatch, NameError#name, and paren-less lambda parameters.
module Lookup
  module Inc
