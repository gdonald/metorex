...
one = "/tmp/metorex_lineloop_parens_one.txt"
...
drained = ARGF.class.new("/tmp/metorex_lineloop_parens_two.txt")
File.write("/tmp/metorex_lineloop_parens_two.txt", "only\n")
drained.read
begin
  drained.rewind
...
File.delete("/tmp/metorex_lineloop_parens_two.txt")
