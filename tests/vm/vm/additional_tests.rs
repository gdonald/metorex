// Coverage tests for uncovered paths in vm/statement.rs and vm/core.rs:
// - Instance/class variable errors at top level
// - attr_reader/writer/accessor outside class
// - include/extend outside class
// - MethodDef at top level
...
// ── Instance variable assignment at top level ─────────────────────────────────
