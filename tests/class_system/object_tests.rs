...
fn test_object_hash_nil() {
    ...
    assert!(hash.is_some());
    // nil hashes are equal to themselves
...
fn test_object_hash_symbol() {
    ...
    assert!(hash.is_some());
    // symbol hashes differ from string hashes
...
// ============================================================================
// Display coverage for Set with multiple elements (display.rs lines 55-58)
// ============================================================================

#[test]
fn test_set_display_multiple_elements() {
    let mut set = HashSet::new();
    set.insert(metorex::object::ObjectHash::from_object(&Object::Int(1)).unwrap());
    set.insert(metorex::object::ObjectHash::from_object(&Object::Int(2)).unwrap());
    let obj = Object::Set(Rc::new(RefCell::new(set)));
    let display = format!("{}", obj);
    // Should contain both elements separated by comma
...
// ============================================================================
// Display coverage for NativeFunction (display.rs line 66)
// ============================================================================
...
// ============================================================================
// is_falsy coverage (operations.rs lines 17-18)
// ============================================================================
...
// ============================================================================
// equals coverage for Module, Binding (operations.rs lines 66, 69)
// ============================================================================
...
// ============================================================================
// Binding get/keys coverage (binding.rs lines 23-24, 28-29)
// ============================================================================
...
// ============================================================================
// exception_with_cause coverage (constructors.rs lines 55, 60-63)
// ============================================================================
...
// ============================================================================
// Method constructors coverage (method.rs lines 53, 62, 66, 93, 103, 107, 108)
// ============================================================================
...
// ============================================================================
// Heap coverage (heap.rs lines 17-18)
// ============================================================================
...
// ============================================================================
// MetorexError From<io::Error> coverage (error.rs lines 126-127)
// ============================================================================
