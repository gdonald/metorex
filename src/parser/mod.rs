...
impl Parser {
    ...
    fn parse_begin_statement(&mut self) -> Result<Statement, MetorexError> {
    ...
    fn parse_rescue_clause(&mut self) -> Result<RescueClause, MetorexError> {
    ...
    fn parse_raise_statement(&mut self) -> Result<Statement, MetorexError> {
