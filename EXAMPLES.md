...
- [x] 1.1.3 Use `tests/_examples/basics/greeting_line.rb` in an actual test in examples_runner.rs
...
- [x] 2.1.3 Use `tests/_examples/data-structures/simple_dict.rb` in an actual test in examples_runner.rs
...
- [x] 2.2.4 Use `tests/_examples/data-structures/dict_access.rb` in an actual test in examples_runner.rs
- [x] 2.2.5 Use `tests/_examples/type-annotations/collection_types.rb` in an actual test in examples_runner.rs
...
- [x] 3.2.4 Use `tests/_examples/algorithms/factorial_iterative.rb` in an actual test in examples_runner.rs
- [x] 3.2.5 Use `tests/_examples/algorithms/average_temperature.rb` in an actual test in examples_runner.rs (needs Float.round method)
- [x] 3.2.6 Use `tests/_examples/algorithms/primes_under_fifty.rb` in an actual test in examples_runner.rs
...
- [x] 4.2.4 Use `tests/_examples/functions/closures_nested.rb` in an actual test in examples_runner.rs
- [x] 4.2.5 Use `tests/_examples/functions/locals_scope.rb` in an actual test in examples_runner.rs (requires `.map` with block)
- [x] 4.2.6 Use `tests/_examples/functions/nonlocal_counter.rb` in an actual test in examples_runner.rs (requires mutable closure variables)
...
- [x] 4.3.4 Use `tests/_examples/functions/test_lambdas.rb` in an actual test in examples_runner.rs
- [x] 4.3.5 Use `tests/_examples/metaprogramming/blocks_as_objects.rb` in an actual test in examples_runner.rs (partial - requires Class.new method)
...
- [x] 5.1.4 Use `tests/_examples/algorithms/filter_even_numbers.rb` in an actual test in examples_runner.rs
- [x] 5.1.5 Use `tests/_examples/algorithms/character_counter.rb` in an actual test in examples_runner.rs
- [x] 5.1.6 Use `tests/_examples/algorithms/zip_merger.rb` in an actual test in examples_runner.rs
...
- [x] 5.2.3 Use `tests/_examples/algorithms/matrix_transpose.rb` in an actual test in examples_runner.rs
...
- [x] 6.1.4 Use `tests/_examples/oop/super.rb` in an actual test in examples_runner.rs
- [x] 6.1.5 Use `tests/_examples/oop/super_chain.rb` in an actual test in examples_runner.rs
- [x] 6.1.6 Use `tests/_examples/oop/test_init_param.rb` in an actual test in examples_runner.rs
...
- [x] 6.3.4 Use `tests/_examples/oop/special_methods.rb` in an actual test in examples_runner.rs
- [x] 6.3.5 Use `tests/_examples/oop/test_str.rb` in an actual test in examples_runner.rs
- [x] 6.3.6 Use `tests/_examples/oop/test_repr.rb` in an actual test in examples_runner.rs
...
- [x] 6.4.3 Use `tests/_examples/oop/test_iter.rb` in an actual test in examples_runner.rs

### 6.5 Attribute Access Methods
- [x] 6.5.1 Implement `method_missing` special method
- [x] 6.5.2 Implement dynamic attribute lookup
- [x] 6.5.3 Use `tests/_examples/oop/test_method_missing.rb` in an actual test in examples_runner.rs
...
- [x] 8.1.4 Use `tests/_examples/control-flow/test_pattern_matching.rb` in an actual test in examples_runner.rs
...
- [x] 8.2.5 Use `tests/_examples/control-flow/case_guard.rb` in an actual test in examples_runner.rs
- [x] 8.2.6 Use `tests/_examples/control-flow/case_array_destructure.rb` in an actual test in examples_runner.rs
- [x] 8.2.7 Use `tests/_examples/control-flow/case_object_destructure.rb` in an actual test in examples_runner.rs
- [x] 8.2.8 Use `tests/_examples/control-flow/case_variable_binding.rb` in an actual test in examples_runner.rs
...
- [x] 9.1.4 Use `tests/_examples/errors/simple_rescue.rb` in an actual test in examples_runner.rs
...
- [x] 9.2.7 Use `tests/_examples/advanced/exception_handling.rb` in an actual test in examples_runner.rs
...
- [x] 10.1.3 Use `tests/_examples/introspection/function_name.rb` in an actual test in examples_runner.rs
- [x] 10.1.4 Use `tests/_examples/introspection/function_module.rb` in an actual test in examples_runner.rs

### 10.2 Code Object Introspection
- [x] 10.2.1 Implement code object access
- [x] 10.2.2 Add bytecode/AST inspection
- [x] 10.2.3 Use `tests/_examples/introspection/code_object.rb` in an actual test in examples_runner.rs

### 10.3 Namespace Introspection
- [x] 10.3.1 Implement namespace/scope inspection
- [x] 10.3.2 Add closure variable inspection
- [x] 10.3.3 Use `tests/_examples/introspection/closure_namespace.rb` in an actual test in examples_runner.rs

### 10.4 Attribute Introspection
- [x] 10.4.1 Implement attribute listing
- [x] 10.4.2 Add dynamic attribute access
- [x] 10.4.3 Use `tests/_examples/introspection/basic_attributes.rb` in an actual test in examples_runner.rs
- [x] 10.4.4 Use `tests/_examples/introspection/annotations.rb` in an actual test in examples_runner.rs
- [x] 10.4.5 Use `tests/_examples/introspection/default_parameters.rb` in an actual test in examples_runner.rs
...
- [ ] 14.1.4 Use `tests/_examples/advanced/dynamic_method_definition.rb` in an actual test in examples_runner.rs

### 14.2 Implicit Block Capture
- [ ] 14.2.1 Implement Ruby-style block capture
- [ ] 14.2.2 Add yield keyword
- [ ] 14.2.3 Use `tests/_examples/advanced/implicit_block_capture.rb` in an actual test in examples_runner.rs
...
- [ ] 15.1.4 Use `tests/_examples/advanced/traits.rb` in an actual test in examples_runner.rs

### 15.2 DSL Support
- [ ] 15.2.1 Implement method chaining optimizations
- [ ] 15.2.2 Add builder pattern support
- [ ] 15.2.3 Use `tests/_examples/advanced/dsl_example.rb` in an actual test in examples_runner.rs

### 15.3 Serialization
- [ ] 15.3.1 Verify JSON serialization works
- [ ] 15.3.2 Add additional format support
- [ ] 15.3.3 Use `tests/_examples/advanced/serialization.rb` in an actual test in examples_runner.rs
...
- [ ] 16.1.4 Use `tests/_examples/advanced/concurrency.rb` in an actual test in examples_runner.rs
...
- [ ] 17.1.4 Use `tests/_examples/advanced/networking.rb` in an actual test in examples_runner.rs
...
- [ ] 18.1.3 Use `tests/_examples/builtins/type_introspection.rb` in an actual test in examples_runner.rs
